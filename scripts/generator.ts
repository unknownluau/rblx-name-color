...
let CHAT_COLORS_BY_VERSION_FN = () => {
	let fakePersimmon = new Color(253, 41, 67, "Really Red");
	let fakeCyan = new Color(1, 162, 255, "Electric Blue");
	let fakeDarkGreen = new Color(2, 184, 87, "Forest Green");
	let brightViolet = new Color(107, 50, 124, "Bright violet")
	let alder = new Color(180, 128, 255, "Lilac")
